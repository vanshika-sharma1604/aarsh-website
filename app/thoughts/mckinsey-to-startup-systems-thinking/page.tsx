        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            <div className="aspect-[4/3] bg-gray-900 rounded-xl mb-8 overflow-hidden">
              <img
                src="/images/systems-thinking.png"
                alt="From McKinsey to Startup: Lessons in Systems Thinking"
                className="w-full h-full object-cover"
              />
            </div>

            <div className="space-y-4">
              <span className="text-sm text-white font-medium bg-gray-800 px-3 py-1 rounded-full">Business</span>
          ...
          <div className="prose prose-lg prose-invert max-w-none">
            ...
            <h2 className="text-3xl font-bold text-white mb-6 mt-12">First Principles: What Systems Actually Are</h2>

            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Principle 1: Holism Over Reductionism</h3>
            <p className="text-gray-300 leading-relaxed mb-6">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              <strong className="text-white">McKinsey example:</strong> When analyzing that $1B AUM leakage for the
              insurance client, I initially focused on individual friction points—confusing forms, slow processing, poor
              communication. Classic reductionist approach.
            </p>

            <p className="text-gray-300 leading-relaxed mb-6">
              <strong className="text-white">Systems insight:</strong> The leakage wasn't caused by any single friction
              point. It emerged from the relationships between these points. Customers who hit one friction point became
              hypersensitive to others. The system behavior (customer churn) arose from the interaction patterns, not
              individual problems.
            </p>

            <p className="text-gray-300 leading-relaxed mb-8">
              <strong className="text-white">AI application:</strong> Our modular AI tools work the same way. Individual
              modules (research analysis, feature prioritization, workflow optimization) are useful, but the real value
              emerges from how they connect and reinforce each other. Insights from research automatically influence
              prioritization, which feeds into workflow planning, creating emergent intelligence no single module could
              achieve.
            </p>

            <h3 className="text-2xl font-bold text-white mb-4 mt-8">
              Principle 2: Interconnectedness and Non-Linear Effects
            </h3>
            <p className="text-gray-300 leading-relaxed mb-6">
            ...
            <p className="text-gray-300 leading-relaxed mb-8">
              <strong className="text-white">Startup reality:</strong> When we improved our user onboarding by 15%, we
              expected 15% better activation rates. Instead, we saw 40% improvement. Why? Better onboarding led to
              higher engagement, which triggered more feature discovery, which increased retention, which improved
              word-of-mouth growth. The system amplified the initial change.
            </p>

            <h3 className="text-2xl font-bold text-white mb-4 mt-8">
              Principle 3: Feedback Loops Drive System Behavior
            </h3>
            <p className="text-gray-300 leading-relaxed mb-6">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              <strong className="text-white">Traditional product development:</strong> Linear process from research →
              insights → features → launch. No feedback loops.
            </p>

            <p className="text-gray-300 leading-relaxed mb-4">
              <strong className="text-white">AI-first approach:</strong> Every component feeds back into every other
              component:
            </p>
            ...
            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Principle 4: Circular Causality</h3>
            <p className="text-gray-300 leading-relaxed mb-6">
              In complex systems, cause and effect are often circular rather than linear.
            </p>

            <p className="text-gray-300 leading-relaxed mb-4">
              <strong className="text-white">Example from our platform:</strong>
            </p>
            ...
            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Principle 5: Emergence</h3>
            <p className="text-gray-300 leading-relaxed mb-6">
              Systems exhibit properties that don't exist in individual components but arise from their interactions.
            </p>

            <p className="text-gray-300 leading-relaxed mb-8">
              <strong className="text-white">Our breakthrough moment:</strong> Individual AI modules were useful but not
              revolutionary. The emergent property—continuous product intelligence—only appeared when modules started
              communicating with each other. The system began exhibiting behaviors we never programmed: predicting user
              needs, identifying market opportunities, optimizing team workflows automatically.
            </p>

            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Principle 6: System Boundaries Matter</h3>
            <p className="text-gray-300 leading-relaxed mb-6">
            ...
            <ul className="text-gray-300 leading-relaxed mb-6 space-y-2">
              <li>• McKinsey boundary: Client organization (inside) vs. market conditions (outside)</li>
              <li>• Startup boundary: Our platform and users (inside) vs. broader tech ecosystem (outside)</li>
              <li>
                • AI system boundary: Connected tools and data sources (inside) vs. human creativity and strategic
                decisions (outside)
              </li>
            </ul>
            ...
            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Principle 7: Stocks and Flows</h3>
            <p className="text-gray-300 leading-relaxed mb-6">
              Systems consist of stocks (accumulations) and flows (rates of change).
            </p>

            <p className="text-gray-300 leading-relaxed mb-4">
              <strong className="text-white">In our AI platform:</strong>
            </p>
            ...
            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Principle 8: Delays Create Complexity</h3>
            <p className="text-gray-300 leading-relaxed mb-6">
              Time delays between actions and effects cause oscillations and make systems hard to control.
            </p>

            <p className="text-gray-300 leading-relaxed mb-4">
              <strong className="text-white">Product development delays:</strong>
            </p>
            ...
            <p className="text-gray-300 leading-relaxed mb-8">
              <strong className="text-white">AI solution:</strong> Compress delays through automation. Our system
              reduces the research-to-insight delay from weeks to hours, enabling real-time product intelligence.
            </p>

            <h2 className="text-3xl font-bold text-white mb-6 mt-12">
              Applying First Principles to Modular AI Architecture
            </h2>
            ...
            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Designing for Emergence</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Optimizing Feedback Loops</h3>
            <p className="text-gray-300 leading-relaxed mb-4">We built feedback mechanisms into every component:</p>
            ...
            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Managing System Boundaries</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Reducing Critical Delays</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <h2 className="text-3xl font-bold text-white mb-6 mt-12">
              The Meta-System: Building Systems That Build Systems
            </h2>
            ...
            <p className="text-gray-300 leading-relaxed mb-8">
              <strong className="text-white">Example:</strong> Our prioritization engine doesn't just score features—it
              learns which scoring criteria matter most for each team's context. A B2B SaaS team might weight customer
              retention differently than a consumer mobile app team. The AI discovers these patterns and adapts its
            ...
            <h2 className="text-3xl font-bold text-white mb-6 mt-12">
              Systems Thinking vs. Traditional Product Development
            </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="text-gray-700 space-y-2">
                    <li>• Optimize individual processes</li>
                    <li>• Linear workflows</li>
                    <li>• Periodic analysis</li>
                    <li>• Human-driven insights</li>
                    <li>• Fixed frameworks</li>
                    <li>• Component optimization</li>
                  </ul>
                </div>
                <div>
                  <h4 className="text-lg font-bold text-gray-900 mb-4">Systems Thinking Approach</h4>
                  <ul className="text-gray-700 space-y-2">
                    <li>• Optimize relationships between processes</li>
                    <li>• Circular feedback loops</li>
                    <li>• Continuous learning</li>
                    <li>• Emergent intelligence</li>
                    <li>• Adaptive frameworks</li>
            ...
            <h2 className="text-3xl font-bold text-white mb-6 mt-12">The Practical Framework: EMERGE</h2>
            ...
            <ul className="text-gray-300 leading-relaxed mb-8 space-y-2">
              <li>
                • <strong className="text-white">E</strong>stablish clear system boundaries
              </li>
              <li>
                • <strong className="text-white">M</strong>ap critical feedback loops
              </li>
              <li>
                • <strong className="text-white">E</strong>nable component interconnections
              </li>
              <li>
                • <strong className="text-white">R</strong>educe system delays
              </li>
              <li>
                • <strong className="text-white">G</strong>enerate emergent properties
              </li>
              <li>
                • <strong className="text-white">E</strong>volve through continuous learning
              </li>
            </ul>

            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Establish Clear System Boundaries</h3>
            <p className="text-gray-300 leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Map Critical Feedback Loops</h3>
            <p className="text-gray-300 leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Enable Component Interconnections</h3>
            <p className="text-gray-300 leading-relaxed mb-8">
              Design modules that can share information and influence each other's behavior. Avoid isolated tools that
              don't communicate.
            </p>

            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Reduce System Delays</h3>
            <p className="text-gray-300 leading-relaxed mb-8">
              Compress the time between action and feedback. Real-time learning beats batch processing for complex
              systems.
            </p>

            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Generate Emergent Properties</h3>
            <p className="text-gray-300 leading-relaxed mb-8">
            ...
            <h3 className="text-2xl font-bold text-white mb-4 mt-8">Evolve Through Continuous Learning</h3>
            <p className="text-gray-300 leading-relaxed mb-8">
              Build meta-learning capabilities so the system improves its own improvement processes.
            </p>

            <h2 className="text-3xl font-bold text-white mb-6 mt-12">Why This Matters Now</h2>
